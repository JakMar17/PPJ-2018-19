...
(* OCaml ima ponesreÄno implementirano funkcijo za primerjavo vrednosti.
...
(* Vrni true, Äe se x pojavi v drevesu, sicer false *)
...
(** Vstavimo ĹĄtevila oblike (17 n^2 + 3 n + 8) mod 103. *)
let d =
